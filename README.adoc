...
NOTE: This repo includes Odin's `vendor:x11/xlib` package with some modifications given some bindings were incorrect (and thus unusable) and I wanted this to compile with the `odin` package of my distro (I use Arch btw)
...
== Bugs
* Very rarely, seen some windows lose focus when it didn't feel right for them to do so
